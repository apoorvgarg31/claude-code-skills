...
## Classification Report (`classification.xlsx`)
...
## Vendor Extract (`<vendor-slug>.xlsx`)
...
## Audit Findings (`audit-findings.xlsx`)
...
### Severity Colors
- 🔴 Error: Red background (#FFC7CE), dark red text (#9C0006)
- 🟡 Warning: Yellow background (#FFEB9C), dark yellow text (#9C6500)
- ℹ️ Info: Blue background (#BDD7EE), dark blue text (#1F4E79)
